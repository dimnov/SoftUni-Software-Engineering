describe('Tests for PaymentPackage Class', () => {
  describe('Tests for the Name', () => {
    ...
    it('Should throw errow when the new Name is an array', () => {
      expect(() => new PaymentPackage(['hello'], 111)).to.throw('Name must be a non-empty string');
    });
    it('Should throw errow when the new Name is empty', () => {
      expect(() => new PaymentPackage('', 2222)).to.throw('Name must be a non-empty string');
    });
    it('Should return the new Name if the input is good', () => {
      expect(() => new PaymentPackage('good', 555)).not.to.throw('Name must be a non-empty string');
    });
  });
  describe('Tests for the Value', () => {
    it('Should throw errow when the new Value is a string', () => {
      expect(() => new PaymentPackage('abc', 'cba')).to.throw('Value must be a non-negative number');
    });
